...
class Parameter_server:
    def __init__(self):
        ...
        train_img = np.load('./data/train.npy')  # shape(50000, 3072)
        train_lbl = np.load('./data/train_lbl.npy')  # shape(50000,)
        one_train_lbl = np.load('./data/one_train_lbl.npy')  # shape(50000, 10)
        test_img = np.load('./data/test.npy')  # shape(50000, 3072)
        test_lbl = np.load('./data/test_lbl.npy')  # shape(50000,)
